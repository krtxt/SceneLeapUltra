...
def main(cfg: OmegaConf) -> None:
    ...
    for ckpt_path in checkpoint_paths:
        ...
        try:
            ...
            elif test_cfg.model.name == "GraspFlowMatching":
                model = FlowMatchingLightning(test_cfg.model)
            else:
                raise ValueError(f"Unknown model name: {test_cfg.model.name}. Supported: GraspCVAE, GraspDiffuser, GraspFlowMatching")
